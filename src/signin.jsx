                ...
                <div className='h-[90vh] w-[70vw] bg-background flex items-center justify-start'>
                    <div className='flex items-center py-5 h-full w-1/2 px-15 bg-backgroundlight flex-col'>
                        ...
                        <div className='self-start px-10'>
                            ...
                            <h4 className='text-gray text-sm'>Sign in to your account</h4>
                        </div>
                        <div className='bg-white w-full h-5 my-5'></div>
                        <div class="w-full flex items-center justify-center text-white mb-3">
                            <div class="flex-1 border-t border-gray"></div>
                    ...
                    placeholder:italic"
                        ...
                        <button className='!rounded-xl greenButton w-full text-2xl font-bold my-5'>Sign In</button>
                        <h6 className="text-gray text-sm">Don't Have An Account? <span className="text-md text-white underline cursor-pointer">Sign Up</span></h6>
